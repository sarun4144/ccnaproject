...
,Easyrecord,Hardrecord,CountStamp,removeExam,listexamSort,listexamSortDate , examstatuschange} = require("../Controller/Exam");
...
router.post("/examstatuschange",auth,adminCheck,examstatuschange);
